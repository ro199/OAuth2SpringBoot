package com.krugerChallenge.authorizationserver.entity;
...
public class Client {
    ...
    public static RegisteredClient toRegisteredClient(Client client){
        RegisteredClient.Builder builder = RegisteredClient.withId(client.getClientId())
                ...
                .clientAuthenticationMethods(am -> am.addAll(client.authenticationMethods))
                .authorizationGrantTypes(agt -> agt.addAll(client.authorizationGrantTypes))
